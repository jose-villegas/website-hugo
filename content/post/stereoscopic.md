...
The project code can be found on my GitHub [here](https://github.com/jose-villegas/StereoscopicRendererMeshSim). The render engine loads meshes and can create different primitives, as well define scenes with different cameras, lights and objects. There are other techniques in the engine such as normal mapping.
